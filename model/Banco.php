...
class Banco {
    ...
    public function updateChar($arrDadosForm)
    {
        $tabela = $arrDadosForm['tabela'];
        unset($arrDadosForm['tabela']);
        unset($arrDadosForm['method']);
    ...
    public function deleteChar($arrDadosForm)
    {
        $tabela = $arrDadosForm['tabela'];
        $id = $arrDadosForm['id'];
        $campo = $arrDadosForm['campo_where'];
    ...
    public function listaDadosChar($tabela, $id = null, $order = null, $campo_where = null)
    {


        (($id > 0) ? $where = " WHERE $campo_where  '$id'" : $where = null );
        (($order != '') ? $order = " ORDER BY {$order}" : $order = null);
