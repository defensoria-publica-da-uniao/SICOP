<?php ?>
<div class="modal fade bs-modal-lg" id="cadastroAndamento" tabindex="-1" role="dialog" aria-hidden="true">
                        ...
                        <div class="panel-body">
                            <div class="row" style="margin-left: -0px !important; margin-right: -0px !important;">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <select class="form-control" id="paises" name="arrDadosForm[id_tp_andamento]">
                                        <?php
