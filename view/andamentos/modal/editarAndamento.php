    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content" >
            ...
            <div class="modal-header" align="center">
                ...
                <h4 class="modal-title"><b>Editar Andamentos</b></h4>
            </div>
                            ...
                            <div class="row" style="margin-left: -0px !important; margin-right: -0px !important;">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="input-group  input-daterange " data-date-format="">
                                        ...
                                        <input type="date" class="form-control" placeholder="Data Final" id="dt_finalEditar" name="arrDadosForm[dt_prz_fim]" required="">
                                    </div>
                                </div>
                            </div>
                            <div class="row" style="margin-left: -0px !important; margin-right: -0px !important;">
                                <div class="form-group col-md-6">
                                    <label style="text-align:left !important;" >O andamento está pendente?<class="required" aria-required="false"></label>
