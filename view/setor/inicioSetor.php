                        ...
                        <tbody>
                            ...
                            while ($arSetores = mssql_fetch_array($resultSetores)) {
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $arSetores['id_setor']; ?></td>
                                    <td><?php echo utf8_encode(($arSetores['descr_setor'])); ?></td>
                                    <td><?php echo ($arSetores['cod_unidade']); ?></td>
                                    <td><?php echo $arSetores['dt_atualiz']; ?></td>
                                    <td><?php echo $arSetores['str_login']; ?></td>
...
<script>
                $(document).ready(function() {
                    $('#editarSetores').on('show.bs.modal', function(e) {
                        ...
                        $.ajax({
                            type: 'POST',
                            data: 'codigo=' + id_setor + '&method=listEditsetor&acao=ajax',
                            url: '<?php echo CONTROLLER; ?>setor.php',
                            success: function(data) {
                                ...
                                $("#cod_uniEditar").val(response.cod_uni);
                            }
                        });
                    });
                });
