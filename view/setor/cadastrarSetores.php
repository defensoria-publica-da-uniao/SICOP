<div class="modal fade bs-modal-lg" id="cadastrarSetores" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content" >
            ...
            <form role="form" name="form_login" method="POST" accept-charset="utf-8" action="<?php echo CONTROLLER . 'setor.php' ?>" >
                <input type="hidden" name="arrDadosForm[method]" value="cadastrarSetor">
                            ...
                            <div id="resultModal" class="fetched-data">
                                <div class="row" style="margin-left: -0px !important; margin-right: -0px !important;">
                                    <div class="form-group col-md-8">
                                        <label style="text-align:left !important;" >Descrição do Setor</label>
                                        <input class="form-control" type="text" name="arrDadosForm[descr_setor]" id="descricao" type="text" >
                                    </div>
                                </div>
                                <div class="form-group col-md-8">
                                    <label style="text-align:left !important;" >Unidade <span class="required" aria-required="false">*</span></label>
                                    <select class="form-control" id="organiza" name="arrDadosForm[cod_unidade]">
                                      <?php
