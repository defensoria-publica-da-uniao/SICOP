    ...
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
        ...
        <div class="portlet light ">
            <div class="portlet-body">
                ...
                <h3 class="">Colunas de cada linha da página</h3>
                <hr>
                <div class="m-grid m-grid-demo">
                    <div class="m-grid-row">
                        ...
                        <div class="m-grid-col m-grid-col-middle m-grid-col-center m-grid-col-md-3 m-grid-col-md-offset-2">m-grid-col-md-3--</div>
            ...
            <div class="portlet-body">
                <table class="table table-striped table-bordered table-hover dt-responsive" width="100%" id="sample_5">
                    ...
                    <tbody>
                        ...
                        <!--
                        <?php
                        if ($contAndar == $qtdAndaresUnidade) {
                            $cont_validados = $cont_validados + 1;
                        } else {
                            $cont_verificar = $cont_verificar + 1;
                        }
                        ?>

                        <input type="hidden" id="cont_ini1" value="<?php echo $cont_validados; ?>">
                        <input type="hidden" id="cont_ini2" value="<?php echo $cont_verificar; ?>">
                        -->
...
<!--
<div id="cont_final1"> </div>    ESTE id FICA ANTES DO LOOP

RECEBER VALOR E MOSTRAR ELE ANTES DO LOOP VIA id
-->


<script>
    $(document).ready(function() {
        var cont_final1 = $('#cont_ini1').val();
        var cont_final2 = $('#cont_ini2').val()

        document.getElementById("cont_final1").innerHTML = cont_final1;
        document.getElementById("cont_final2").innerHTML = cont_final2;
