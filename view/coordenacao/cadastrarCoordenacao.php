<div class="modal fade bs-modal-lg" id="cadastrarCoordenacao" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content" >

            <div class="modal-header" align="center">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
                <h4 class="modal-title"><b>Cadastrar Coordenações</b></h4>
            </div>

            <form role="form" name="form_login" method="POST" accept-charset="utf-8" action="<?php echo CONTROLLER . 'coordenacao.php' ?>" >
                <input type="hidden" name="arrDadosForm[method]" value="cadastrarCoordenacao">
                        ...
                        <div class="panel-body">
                            <div id="resultModal" class="fetched-data">
                                <div class="row" style="margin-left: -0px !important; margin-right: -0px !important;">
                                    ...
                                    <div class="form-group col-md-8">
                                        <label style="text-align:left !important;" >Sigla da Coordenacao</label>
