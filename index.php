...
<?php if (@$_SESSION['VALID'] and ( $modulo != 'login' )) { ?>
    ...
    <html lang="br">
        <head>
            ...
            <link href="<?php echo CSS; ?>page-level-plugins/jquery.fancybox.css" rel="stylesheet" type="text/css" />       <!-- Amplicar a imagem - Manual -->
            <link href="<?php echo CSS; ?>page-level-plugins/bootstrap.touchspin.css" rel="stylesheet" type="text/css" />   <!-- Quantidade Formulário botões de '+' e '-' -->
            ...
            <script src="<?php echo JS; ?>page-level-plugins/jquery.fancybox.pack.js" type="text/javascript"></script>          <!-- Amplicar a imagem - Manual -->
            <script src="<?php echo JS; ?>page-level-plugins/bootstrap.touchspin.js" type="text/javascript"></script>           <!-- Quantidade Formulário botões de '+' e '-' -->
            <!-- END PAGE LEVEL PLUGINS -->
            ...
            <script src="<?php echo JS; ?>page-level-scripts/components-bootstrap-touchspin.js" type="text/javascript"></script><!-- Quantidade Formulário botões de '+' e '-' -->
        ...
        <body class="page-sidebar-closed-hide-logo page-container-bg-solid">
            ...
            <!-- SELECT 2 -->
            <link href="<?php echo CSS; ?>select2.css" rel="stylesheet" type="text/css" />
            <script src="<?php echo JS; ?>select2.js" type="text/javascript"></script>
            <script>
                $('#select2').select2({
